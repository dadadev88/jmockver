...
1. Create a new `feature/bugfix/hotfix` branch from `master`, add changes and after test all is working.
...
4. Create a Pull Request from `feature/bugfix/hotfix` branch to the `develop`
...
2. Create a Pull Request from `feature/bugfix/hotfix` branch to the `develop` branch
